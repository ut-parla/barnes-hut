...
class GravitySelfOther1Functor:
    def __init__(self, c1_positions, c2_positions, c2_masses, G):
        ...
        self.p_pos: pk.View2D[pk.double] = pk.View(list(c1_positions.shape), pk.double)
        self.p_pos.data[:] = c1_positions[:]
...
class GravitySelfOther2Functor:
    def __init__(self, c1_positions, c2_positions, c1_masses, c2_masses, G):
        ...
        self.p_pos: pk.View2D[pk.double] = pk.View(list(c1_positions.shape), pk.double)
        self.p_pos.data[:] = c1_positions[:]
        self.p_mass: pk.View1D[pk.double] = pk.View(list(c1_masses.shape), pk.double)
        self.p_mass.data[:] = c1_masses[:]
